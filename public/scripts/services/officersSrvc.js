...
window.app.factory('officersSrvc', [function () {
	return function () {
	    ...
	    },
	    {
	        ...
	        content: [
	        	'As CFO of Mahaska, Pam Willard is responsible for all accounting functions, financial reporting, acquisition analysis, audit and tax functions, 401(k) plan administration, and special projects. Willard joined Mahaska in February 2000 as the Company Controller and was later promoted to Chief Financial Officer. She has been instrumental in putting controls in various processes and improving the accuracy of financial reporting',
				'Prior to her current role, Willard spent 4 years working in the farm machinery industry, 2 years in commercial framing manufacturing (mainly for strip shopping centers), 11 years in the commercial HVAC industry, 2 years in public transportation, and 2 years in light manufacturing. Growing up she sold garden seeds door to door, held a newspaper route, picked up rocks for farmers and worked in her Mother’s restaurant– where Pepsi was a staple. In junior college Willard worked for Meredith Corporation in their Real Estate division.',
	    ...
	    },
	    {
	        ...
	        content: [
	        	...
	        	'As Mahaska continued to change and grow, Davis was given the position of General Manager in 1993. He has since helped research and implement software from Salient Corporation, Descartes (High Jump), Rutherford (MEI) in efforts to help provide tools that enable Mahaska to run as efficiently as possible. These systems have been an integral part in providing Davis the opportunity to analyze sales trends for the whole company. Davis loves the challenge of using these tools to access every funding dollar available which in turn helps with customer development for Mahaska\'s many partners.',
	    ...
	    },
	    {
	        ...
	        content: [
	        	'As GM for the Mahaska Franchise Headquartered in Kansas, Jim Frush is responsible for improving both sales volumes and operations efficiency in all facets of Mahaska’s businesses. Growing up and in Oskaloosa, Iowa, Frush had several paper routes and spent several years in the grocery business doing everything from stocking and carrying out groceries to Night Manager. Hired by Mahaska Bottling Co in August of 1982, Frush accepted a Route Sales position in Ottumwa and Fremont Iowa. He used his knowledge of the grocery business to increase the sales and distribution of Mahaska’s products in his grocery and convenience stores to build sales and won Salesman of the Year Awards back to back. He then was recruited to change sales territories and accepted the Knoxville, IA Territory, where he won 3 more Salesmen of the Year Awards over the next 6 years.',
	        	'Frush then accepted the position of Route Director, with supervisory responsibilities over 4 Route Salespeople and a Mahaska Warehouse in Centerville, Iowa. Before one year passed, Frush was approached by Bradley Muhl and offered another promotion, Marketing Director, in Mahaska’s Salina, KS plant. Frush’s responsibilities were to manage a sales force of over 3 dozen people, increase distribution and sales and importantly, morale. He accomplished these goals and was then recruited to perform the same functions for the entire company, for thirteen years as Chief Marketing Officer. Frush was responsible for all customers, local and corporate, initiated several innovative sales incentives and programs that resulted in increased sales and profits.',
	        	'When the position of General Manager for the Kansas operation opened in 2009, Frush assumed those responsibilities. Frush also manages brand partner relations and new opportunities for all of Mahaska. Frush Graduated from Oskaloosa High School, took night classes for Real Estate, and graduated from Drake University in Des Moines, IA.  In addition, he has taken dozens of sales and business training courses over the years. Frush enjoys golf, hunting and fishing.'
	        ]
	    }
	    ];
	  	return officers;
